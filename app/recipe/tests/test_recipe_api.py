...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        for ingredient in payload['ingredients']:
            created_ingredient = recipe.ingredients.filter(
                name=ingredient['name'],
                user=self.user,
            )
            self.assertTrue(created_ingredient.exists())
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        recipe = create_recipe(user=self.user)
        recipe.ingredients.add(ingredient_flour)
        ...
        self.assertNotIn(ingredient_flour, recipe.ingredients.all())
    ...
    def test_filter_by_ingredients(self):
        ...
        ingredient1 = Ingredient.objects.create(name='Feta', user=self.user)
        ingredient2 = Ingredient.objects.create(name='Chicken', user=self.user)
